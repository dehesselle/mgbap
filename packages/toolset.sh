...
# Once all of GIMP's dependencies have been collected and built, we bundle
...
TOOLSET_VOLNAME=mgbap_v$TOOLSET_VER

# A disk image containing a built version of the whole toolset.
# https://github.com/dehesselle/mgbap
TOOLSET_URL=https://github.com/dehesselle/mgbap/releases/download/\
